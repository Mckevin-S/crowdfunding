...
/**
 * Repository interface for {@link Contribution} entity.
 * Provides aggregation methods for summing contribution amounts by project.
 */
public interface ContributionRepository extends JpaRepository<Contribution, Long> {
    ...
    List<Contribution> findByProjetAndUtilisateur(@Param("projet") Projet projet,
