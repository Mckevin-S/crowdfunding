...
public class ContributionController {
    ...
    public ResponseEntity<ContributionResponseDTO> createContribution(
        ...
        log.info("CREATION_CONTRIBUTION: Nouvel enregistrement de contribution pour le projet ID: {} par l'utilisateur ID: {}", 
                request.getProjetId(), request.getUtilisateurId());
