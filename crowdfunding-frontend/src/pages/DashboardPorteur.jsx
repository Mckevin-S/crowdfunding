    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-500 font-medium font-display leading-tight">Gérez vos campagnes et suivez vos financements.</p>
          </div>
        </div>
      ...
      <Card className="p-0 border-none shadow-sm overflow-hidden bg-white">
        <div className="p-8 border-b border-slate-50 flex items-center justify-between">
          ...
          <Link to="/porteur/mes-projets" className="text-sm font-bold text-primary-600 hover:text-primary-700">
            Voir tout
          </Link>
        </div>
        <div className="overflow-x-auto">
          {loading ? (
            <div className="p-20 text-center text-slate-400 font-medium font-display italic">Recherche de vos ambitions...</div>
          ) : projects.length === 0 ? (
            <div className="p-20 text-center">
               <div className="w-20 h-20 bg-slate-50 rounded-3xl flex items-center justify-center mx-auto mb-6 text-slate-300">
                  <Rocket className="w-10 h-10" />
               </div>
               <h4 className="text-xl font-bold text-slate-800 mb-2 font-display">Prêt à changer l'Afrique ?</h4>
               <p className="text-slate-500 mb-8 max-w-sm mx-auto font-medium">Vous n'avez pas encore créé de projet. C'est le moment de présenter votre vision au monde.</p>
               <Link to="/projects/create">
                    ...
                    <tr key={project.id} className="hover:bg-slate-50/30 transition-colors group">
                      ...
                      <td className="px-8 py-6">
                        <div className="flex flex-col">
                           ...
                           <span className="text-[10px] text-slate-400 font-bold uppercase tracking-tighter">Objectif: {project.objectifFinancier?.toLocaleString()}</span>
                        </div>
                      </td>
                      <td className="px-8 py-6">
